...
/// @title MerkleClaim
/// @notice Claims KDO for members of a merkle tree
...
contract MerkleClaim {
    ...
    /// @notice KDO token to claim
    IKodo public immutable KDO;
    ...
    constructor(address _kodo, bytes32 _merkleRoot) {
        KDO = IKodo(_kodo);
    ...
    function claim(
        ...
        require(KDO.claim(to, amount), "CLAIM_FAILED");
